<section class="h-screen w-full">
    <div class="relative bg-cover bg-center h-full ">
        <div style="background-image: url('/assets/img/code.png');;" class="absolute inset-0  bg-cover bg-center z-0" data-aos="fade-right"
             data-aos-easing="linear"
             data-aos-duration="500">></div>
        <div class="relative z-10 h-full float-end bg-white w-1/2" data-aos="fade-left"
             data-aos-easing="linear"
